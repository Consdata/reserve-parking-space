...
import {showFreeParkingSpaces} from './show-free/show-free-rooms.handler';
import * as admin from 'firebase-admin';
import {reserveParkingSpace} from './reserve/reserve.handler';

export const reserveParkingSpaceInteractionFactory = (
